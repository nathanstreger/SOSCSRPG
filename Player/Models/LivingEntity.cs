    ...
    public abstract class LivingEntity : BaseNotificationClass
    {
        ...
        public Skill CurrentSkill
        {
            ...
            set
            {
                ...
                {
                    _currentSkill.Action.OnActionPerformed -= RaiseActionPerformedEvent;
                }
        ...
        public ObservableCollection<Skill> LearnedSkills { get; }
                               ...
                               int gold, int level = 1)
        {
            ...
            LearnedSkills = new ObservableCollection<Skill>();
        }
        ...
        public void UseCurrentSkillOn(LivingEntity target)
        {
            CurrentSkill.PerformAction(this, target);
        }
